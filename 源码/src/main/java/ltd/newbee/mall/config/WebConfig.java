...
import ltd.newbee.mall.util.interceptor.AdminLoginInterceptor;
import ltd.newbee.mall.util.interceptor.AdminViewModelInterceptor;
import ltd.newbee.mall.util.interceptor.MallLoginValidateInterceptor;
import ltd.newbee.mall.util.interceptor.RepeatSubmitInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // 本地文件上传路径
        registry.addResourceHandler("/upload/**", "/goods-img/**").addResourceLocations("file:" + mallConfig.getUploadDir() + "/");
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // 后台演示模式拦截器
        registry.addInterceptor(new AdminViewModelInterceptor(mallConfig))
